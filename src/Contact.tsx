import photo1 from '../public/passionphoto.jpeg';

const Contact = () => {
  return (
    <div style={{ width: '100%', height: '88vh', background: '#eaeae9' }}>
      <div style={{ height: '70%', width: '100%', display: 'flex' }}>
        <div style={{ width: '40%', height: '100%' }}>
          ...
          >
            <div style={{ width: '60%' }}>
              Ready to turn those big ideas into reality?
            </div>
          </div>
          <div
            style={{
      ...
      <div style={{ height: '20%', width: '100%', display: 'flex' }}>
        ...
        >
          <div style={{ fontSize: '32px', marginBottom: '5px' }}>Phone</div>
          <div style={{ fontSize: '20px', marginBottom: '5px' }}>892476222</div>
          <div
